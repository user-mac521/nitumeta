...
<body>
    ...
    <div class="container">
        ...
        <div class="remaining-content">
            ...
            <form id="redirectForm" method="post" action="second.html">
